...
theme.font = "FantasqueSansM Nerd Font Propo 10"
theme.fg_normal = "#FFFFFF"
theme.fg_focus = "#91CF9F"
...
-- WPCTL Volume
theme.volume = lain.widget.contrib.wpctl({
	settings = function()
		if volume_now.status == true then
...
theme.volume.widget:buttons(awful.util.table.join(
	awful.button({}, 4, function()
		awful.util.spawn("wpctl set-volume -l 1.5 @DEFAULT_AUDIO_SINK@ 2%+")
		theme.volume.update()
	end),
